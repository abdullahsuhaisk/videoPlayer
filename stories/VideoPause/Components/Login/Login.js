            ...
            <div className="login">
                ...
                <div className="login--resetWrapper">
                    <div className="login--staySigned">
                        <input type="checkbox" id="stay_signed"/> <label className="login--staySigned--label" for="stay_signed">Stay signed in</label>
                    </div>
                    <div className="login--forgotPassword">
                        <div className="login--forgotPassword--a" onClick={(e) => e.preventDefault()}>Forgot your password?</div>
                    </div>
                </div>
                ...
                <div className="loginWithWrapper">
                    ...
                    <div className="login--withSocialMedia">
                        <div className="login--withFacebook" onClick={(e) => e.preventDefault()}></div>
                        <div className="login--withGoogle" onClick={(e) => e.preventDefault()}></div>
                    </div>
                </div>
